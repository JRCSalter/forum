...
else
{
  ...
  $name = $_POST[ "name" ] ?
          preg_replace( "/[^a-zA-Z]/", " ", $_POST[ "name" ] ) :
          NULL;
  $age  = $_POST[ "age"  ] ?
          preg_replace( "/[^0-9]/",    " ", $_POST[ "age"  ] ) :
          NULL;
  $dob  = $_POST[ "dob"  ] ?
          preg_replace( "/[^0-9-]/",   " ", $_POST[ "dob"  ] ) :
          NULL;

  $password = ( $_POST[ "password1" ] == $_POST[ "password2" ] ) ?
              preg_replace( "/[^A-Za-z0-9-]/",   " ", $_POST[ "password1"  ] ) :
              NULL;
